...
OpacTex = targetNode.evalParm("opaccolor_texture")
...
#Opacity
OpacReader = MtlSub.createNode("mtlximage","Opacity")
OpacReader.setParms({"file":OpacTex})
mtlxsurface.setInput(38,OpacReader,0)
